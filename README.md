...
Handles requests (Create, Join, ...) at ```/games```

## Active game logic (long-polling)
- The user authenticates with a game_token
...
4. The client can make an event (move, resign, ...) on ```/games/{id}/actions```
...
You can then execute your native executable with: `./target/gameplay_games-ms_-1.0.0-SNAPSHOT-runner`
